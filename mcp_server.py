...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Item Element -- are browsable via browse_model/search_model_objects under any phase "
        "(searched model-wide, since they live under a DataPkg, not one architecture layer). "
        ...
        "nested creation) all work with no _type injection needed. Not supported: creating a "
        "fresh min_card/max_card (Min/Max Cardinality) where none exists yet -- decl.py can "
        "append to lists or mutate an existing sub-object but can't create a new object into "
        "an empty Single container; set Min/Max Card in the Capella desktop editor instead. "
